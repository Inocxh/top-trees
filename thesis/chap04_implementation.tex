...
in \Cpp. More precisely they are written in \Cpp14 with frequent use of smart
pointers introduced in \Cpp11 and \Cpp14, which helped a lot with memory handling.
